...
import pk.elfo.gameserver.model.actor.instance.L2QuestGuardInstance;
...
public final class Q727_HopeWithinTheDarkness extends Quest
{
	...
	protected static final Logger _log = Logger.getLogger(Q727_HopeWithinTheDarkness.class.getName());
	...
	protected static final int[] MONSTERS =
	{
		25656,
		25657,
		25658
	...
	protected String enterInstance(L2PcInstance player, String template, Location loc, CastleDungeon dungeon, String ret)
	{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		{
			enterInstance(player, "castlepailaka.xml", new Location(48163, -12195, -9140), _castleDungeons.get(npc.getNpcId()), checkEnterConditions(player, npc));
			return null;
		}
	...
	public static void main(String[] args)
	{
		...
		new Q727_HopeWithinTheDarkness(727, Q727_HopeWithinTheDarkness.class.getSimpleName(), "Hope Within The Darkness");
	}
}
