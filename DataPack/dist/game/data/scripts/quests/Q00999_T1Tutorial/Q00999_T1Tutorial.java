...
public class Q00999_T1Tutorial extends Quest
{
    ...
    public Q00999_T1Tutorial(int id, String name, String descr)
    {
        super(id, name, descr);
        ...
        Level2.put(30598, new Object[] {"30598-L2.htm",-84436,242793,-3728,"Q00001_LettersOfLove"});
        Level2.put(30599, new Object[] {"30599-L2.htm",42978,49115,-2992,"Q00002_WhatWomenWant"});
        Level2.put(30600, new Object[] {"30600-L2.htm",25856,10832,-3720,"Q00166_MassOfDarkness"});
        Level2.put(30601, new Object[] {"30601-L2.htm",112656,-174864,-608,"Q00005_MinersFavor"});
        Level2.put(30602, new Object[] {"30602-L2.htm",-47360,-113791,-224,"Q00004_LongLiveThePaagrioLord"});
        Level2.put(32135, new Object[] {"32135-L2.htm",-119378,49242,8,"Q00174_SupplyCheck"});

        Level6.put(30598, new Object[] {"30598-L6.htm",-82236,241573,-3728,"Q00257_TheGuardIsBusy"});
        Level6.put(30599, new Object[] {"30599-L6.htm",42812,51138,-2992,"Q00260_OrcHunting"});
        Level6.put(30600, new Object[] {"30600-L6.htm",7644,18048,-4376,"Q00265_BondsOfSlavery"});
        Level6.put(30601, new Object[] {"30601-L6.htm",116103,-178407,-944,"Q00293_TheHiddenVeins"});
        Level6.put(30602, new Object[] {"30602-L6.htm",-46802,-114011,-112,"Q00273_InvadersOfTheHolyLand"});
        Level6.put(32135, new Object[] {"32135-L6.htm",-119378,49242,8,"Q00281_HeadForTheHills"});

        Level10.put(0, new Object[] {"human_fighter_lv10.htm",-71384,258304,-3104,"Q00101_SwordOfSolidarity"});
        Level10.put(10, new Object[] {"human_mage_lv10.htm",-91008,248060,-3560,"Q00104_SpiritOfMirrors"});
        Level10.put(18, new Object[] {"elf_lv10.htm",47595,51569,-2992,"Q00105_SkirmishWithOrcs"});
        Level10.put(25, new Object[] {"elf_lv10.htm",47595,51569,-2992,"Q00105_SkirmishWithOrcs"});
        Level10.put(31, new Object[] {"delf_fighter_lv10.htm",10580,17574,-4552,"Q00103_SpiritOfCraftsman"});
        Level10.put(38, new Object[] {"delf_mage_lv10.htm",10775,14190,-4240,"Q00106_ForgottenTruth"});
        Level10.put(44, new Object[] {"orc_lv10.htm",-46808,-113184,-112,"Q00107_MercilessPunishment"});
        Level10.put(49, new Object[] {"orc_lv10.htm",-46808,-113184,-112,"Q00107_MercilessPunishment"});
        Level10.put(53, new Object[] {"dwarven_fighter_lv10.htm",115717,-183488,-1472,"Q00108_JumbleTumbleDiamondFuss"});
        Level10.put(123, new Object[] {"kamael_fighter_lv10.htm",-118080,42835,712,"Q00175_TheWayOfTheWarrior"});
        Level10.put(124, new Object[] {"kamael_fighter_lv10.htm",-118080,42835,712,"Q00175_TheWayOfTheWarrior"});

        Level15.put(30598, new Object[] {"30598-L15.htm",-84057,242832,-3728,"Q00151_CureForFever"});
        Level15.put(30599, new Object[] {"30599-L15.htm",45859,50827,-3056,"Q00261_CollectorsDream"});
        Level15.put(30600, new Object[] {"30600-L15.htm",11258,14431,-4240,"Q00169_OffspringOfNightmares"});
        Level15.put(30601, new Object[] {"30601-L15.htm",116268,-177524,-880,"296_SilkOfTarantula"});
        Level15.put(30602, new Object[] {"30602-L15.htm",-45863,-112621,-200,"Q00276_TotemOfTheHestui"});
        Level15.put(32135, new Object[] {"32135-L15.htm",-125872,38208,1232,"Q00283_TheFewTheProudTheBrave"});
    ...
    public final String onFirstTalk(L2Npc npc, L2PcInstance player)
    {
        ...
        else if (Util.contains( new int[] {30600, 30601, 30602, 30598, 30599, 32135}, npc.getId()))
        {
