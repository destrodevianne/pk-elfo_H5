...
public final class Q00218_TestimonyOfLife extends Quest
{
	...
	public Q00218_TestimonyOfLife(int questId, String name, String descr)
	{
			...
			switch (npc.getNpcId())
			{
				...
				case ANT_WARRIOR_CAPTAIN:
				{
					if (hasQuestItems(killer, MOONFLOWER_CHARM, PUSHKINS_LIST) && (getQuestItemsCount(killer, ANT_SOLDIER_ACID) < 20))
					{
						...
						{
							playSound(killer, "ItemSound.quest_middle");
	...
	{
		new Q00218_TestimonyOfLife(218, Q00218_TestimonyOfLife.class.getSimpleName(), "Testimony Of Life");
	}
}