...
public class DisciplesNecropolis extends Quest
{
	...
	{
		private FastList<L2Npc> room_1 = null;
		private FastList<L2Npc> room_2 = null;
		private FastList<L2Npc> room_3 = null;
		private FastList<L2Npc> room_4 = null;
		private FastList<L2Npc> room_5 = null;
		private boolean fight;
		
		private FastList<L2Npc> anakim_group = null;
		private FastList<L2Npc> lilith_group = null;
		private FastList<L2Npc> devices = null;
		
		public DiscipleWorld()
		{
			room_1 = new FastList<L2Npc>();
			room_2 = new FastList<L2Npc>();
			room_3 = new FastList<L2Npc>();
			room_4 = new FastList<L2Npc>();
			room_5 = new FastList<L2Npc>();
			fight = false;
			anakim_group = new FastList<L2Npc>();
			lilith_group = new FastList<L2Npc>();
			devices = new FastList<L2Npc>();
		}
	}
	...
	protected void enterInstance(L2PcInstance player)
	{
		...
		{
			final int instanceId = InstanceManager.getInstance().createDynamicInstance("[012] DisciplesNecropolis.xml");
