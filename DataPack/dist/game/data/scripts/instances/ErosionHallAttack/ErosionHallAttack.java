...
public class ErosionHallAttack extends Quest
{
	...
	public ErosionHallAttack(int questId, String name, String descr)
	{
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		for (L2PcInstance partyMember : party.getCommandChannel().getMembers())
		{
			...
			QuestState st = partyMember.getQuestState("Q00696_ConquertheHallofErosion");
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		{
			enterInstance(player, "[035] ErosionHallAttack.xml", ENTER_TELEPORT);
			return "";
		}
		return "";
	}
		...
		if (tmpworld instanceof HEWorld)
		{
			...
			if (npc.getNpcId() == COHEMENES)
			{
				...
				for (int objId : world.getAllowed())
				{
					...
					QuestState st = pl.getQuestState("Q00696_ConquertheHallofErosion");
					if ((st != null) && (st.getInt("cond") == 1))
					{
						st.set("cohemenes", "1");
					}
	...
	{
		new ErosionHallAttack(-1, ErosionHallAttack.class.getSimpleName(), "instances");
	}
}