...
public class DefenceHallOfSuffering extends Quest
{
	...
	private boolean checkConditions(L2PcInstance player)
	{
		...
		for (L2PcInstance partyMember : party.getMembers())
		{
			...
			QuestState st = partyMember.getQuestState("Q00695_DefendTheHallofSuffering");
	...
	public String onKill(L2Npc npc, L2PcInstance player, boolean isSummon)
	{
		...
		if (tmpworld instanceof DHSWorld)
		{
			...
			if (npc.getNpcId() == TUMOR_ALIVE)
			{
				...
				{
					npc.deleteMe();
					L2Npc deadTumor = spawnNpc(TUMOR_DEAD, loc, 0, world.getInstanceId());
	...
	public void notifyCoffinActivity(L2Npc npc, DHSWorld world)
	{
		...
		if (world.tumorIndex <= 0)
		{
			...
			L2Npc aliveTumor = spawnNpc(TUMOR_ALIVE, loc, 0, world.getInstanceId());
	...
	{
		new DefenceHallOfSuffering(-1, DefenceHallOfSuffering.class.getSimpleName(), "instances");
	}
}