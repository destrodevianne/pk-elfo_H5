...
public class ToTheMonastery extends Quest
{
	...
	public String onAdvEvent(String event, L2Npc npc, L2PcInstance player)
	{
		...
		if ((tmpworld instanceof ToTheMonasteryWorld))
		{
			...
			if (npcId == EVIL)
			{
				...
				{
					QuestState check = player.getQuestState(Q10296_SevenSignPoweroftheSeal.class.getSimpleName());
			...
			else
			{
				...
				if (event.equalsIgnoreCase("check_voice"))
				{
					...
					if ((qs != null) && (!qs.isCompleted()))
					{
						...
						else if ((qs.getInt("cond") == 3) && (Rnd.getChance(8)))
						{
					...
					QuestState qs2 = player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName());
				...
				if (event.equalsIgnoreCase("check_follow"))
				{
					...
					QuestState qs3 = player.getQuestState(Q10296_SevenSignPoweroftheSeal.class.getSimpleName());
	...
	public String onTalk(L2Npc npc, L2PcInstance player)
	{
		...
		if (npcId == GLOBE)
		{
			...
			if ((player.getQuestState(Q10294_SevenSignToTheMonastery.class.getSimpleName()) != null) && (player.getQuestState(Q10294_SevenSignToTheMonastery.class.getSimpleName()).getState() == 2) && (player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName()) == null))
			{
				enterInstance(npc, player);
				return null;
			}
			if ((player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName()) != null) && (player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName()).getState() != 2))
			{
				enterInstance(npc, player);
				return null;
			}
			if ((player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName()) != null) && (player.getQuestState(Q10295_SevenSignSolinasTomb.class.getSimpleName()).getState() == 2) && (player.getQuestState(Q10296_SevenSignPoweroftheSeal.class.getSimpleName()) == null))
			{
				enterInstance(npc, player);
				return null;
			}
			if ((player.getQuestState(Q10296_SevenSignPoweroftheSeal.class.getSimpleName()) != null) && (player.getQuestState(Q10296_SevenSignPoweroftheSeal.class.getSimpleName()).getState() != 2))
			{
				enterInstance(npc, player);
				return null;
			}
	...
	protected void enterInstance(L2Npc npc, L2PcInstance player)
	{
		...
		world.addAllowed(Integer.valueOf(player.getObjectId()));
