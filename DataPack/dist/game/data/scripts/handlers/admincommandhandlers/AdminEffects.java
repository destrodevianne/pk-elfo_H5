...
import king.server.gameserver.network.serverpackets.SunRise;
import king.server.gameserver.network.serverpackets.SunSet;
	...
	public boolean useAdminCommand(String command, L2PcInstance activeChar)
	{
		...
		else if (command.startsWith("admin_atmosphere"))
		{
			try
			{
				...
				int duration = "sky".equals(type) && "red".equals(state) && st.hasMoreTokens() ? Integer.parseInt(st.nextToken()) : 0;
