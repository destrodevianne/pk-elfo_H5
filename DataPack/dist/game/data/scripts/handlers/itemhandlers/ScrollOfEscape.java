...
import pk.elfo.gameserver.instancemanager.MapRegionManager.java;
...
import pk.elfo.gameserver.network.serverpackets.MagicSkillUser;
...
public class ScrollOfEscape implements IItemHandler
{
    ...
    /* (non-Javadoc)
     * @see pk.elfo.gameserver.handler.IItemHandler#useItem(pk.elfo.gameserver.model.L2PcInstance, pk.elfo.gameserver.model.L2ItemInstance)
     */
