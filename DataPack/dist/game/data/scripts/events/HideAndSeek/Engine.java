...
public final class Engine 
{
		...
		public StatsSet _holder = null;
        public int _curClue = 0;
        public ScheduledFuture<?> _clueTask = null;
        public ScheduledFuture<?> _endGame = null;
        ...
        protected void endGame(L2PcInstance winner) 
        {
                ...
                FastMap<Integer, Long> rewards = new FastMap<>();
        ...
        public void spawnRegistrationNpc() 
        {
                try 
                {
        ...
        public void unspawnRegistrationNpc() 
        {
                _regNpc.stopRespawn();
        ...
        public class Registration implements Runnable 
        {
                ...
                public void run() 
                {
                        ...
                        if(HideAndSeek._players.size() == 0 || (HideAndSeek.MIN_PLAYERS != -1 && HideAndSeek._players.size() < HideAndSeek.MIN_PLAYERS)) Announcements.getInstance().announceToAll("Event cancelled due lack of participants");
                        else 
                        {
        ...
        public class ClueTask implements Runnable 
        {
                @Override
                public void run() 
                {
