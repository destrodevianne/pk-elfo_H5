...
public class TheLastImperialTomb extends AbstractNpcAI
{
	...
	// Boss: Frintezza
	public TheLastImperialTomb(String name, String descr)
	{
		super(name, descr);
		int[] mob =
		{
		...
		/*
		 * tempfix for messed door cords for (int i = 0; i < 8; i++) { DoorTable.getInstance().getDoor(25150051 + i).setRange(0, 0, 0, 0, 0, 0); }
		 */
	}
