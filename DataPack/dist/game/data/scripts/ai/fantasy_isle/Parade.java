...
public class Parade extends AbstractNpcAI
{
	...
	public Parade(String name, String descr)
	{
		...
		if (DEBUG)
		{
			...
			_log.info("Fantasy Isle: Script iniciara em " + format.format(System.currentTimeMillis() + diff) + " e reiniciara a cada " + (cycle / 3600000) + " hora.");
		}
		...
		public void run()
		{
			for (int i = 0; i < 3; ++i)
			{
				...
				{ // TODO:Provisional
					...
					actor.getAI().setIntention(CtrlIntention.AI_INTENTION_MOVE_TO, new L2CharPosition(goal[0], goal[1], goal[2], goal[3]));
