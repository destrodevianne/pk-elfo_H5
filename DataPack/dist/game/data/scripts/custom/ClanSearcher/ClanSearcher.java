...
// import com.sun.corba.se.spi.orbutil.threadpool.ThreadPoolManager; --> Removendo para evitar erros com o ThreadPoolManager atual

public class ClanSearcher extends Quest
{
	private static final int NpcId = 36606;
	// "timeleft" update time in mins
	...
	private void removeClanPresentation(L2Npc npc, L2PcInstance player)
	{
			...
			Connection con = L2DatabaseFactory.getInstance().getConnection())
		{
			...
			/*
			 * NpcHtmlMessage npcHtml = new NpcHtmlMessage(0); npcHtml.setHtml("<html><body><br>&nbsp;Your presentation has been deleted.</body></html>"); player.sendPacket(npcHtml);
			 */
	...
	{
		try (
			Connection c = L2DatabaseFactory.getInstance().getConnection())
		{
