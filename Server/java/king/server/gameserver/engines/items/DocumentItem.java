 ...
 */
package king.server.gameserver.engines.items;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("king.server.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
