...
public class FenceBuilderManager
{
	...
	private final Map<Integer, L2FenceInstance> _fences = new FastMap<>();
	private final Map<Integer, L2FenceInstance> _fence = new FastMap<>();
	...
	public void main_fence(L2PcInstance pc)
	{
		...
		sb.append("<html><title>KingServer Fence Builder</title><body>");
