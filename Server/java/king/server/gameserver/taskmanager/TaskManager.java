...
import static king.server.gameserver.taskmanager.TaskTypes.TYPE_NONE;
import static king.server.gameserver.taskmanager.TaskTypes.TYPE_SHEDULED;
import static king.server.gameserver.taskmanager.TaskTypes.TYPE_TIME;
...
import king.server.gameserver.taskmanager.tasks.SoIStageUpdater;
import king.server.gameserver.taskmanager.tasks.TaskBirthday;
import king.server.gameserver.taskmanager.tasks.TaskCleanUp;
import king.server.gameserver.taskmanager.tasks.TaskDailySkillReuseClean;
import king.server.gameserver.taskmanager.tasks.TaskGlobalVariablesSave;
import king.server.gameserver.taskmanager.tasks.TaskHappyHourEnd;
import king.server.gameserver.taskmanager.tasks.TaskHappyHourStart;
import king.server.gameserver.taskmanager.tasks.TaskJython;
import king.server.gameserver.taskmanager.tasks.TaskOlympiadSave;
import king.server.gameserver.taskmanager.tasks.TaskRaidPointsReset;
import king.server.gameserver.taskmanager.tasks.TaskRecom;
import king.server.gameserver.taskmanager.tasks.TaskRestart;
import king.server.gameserver.taskmanager.tasks.TaskScript;
import king.server.gameserver.taskmanager.tasks.TaskSevenSignsUpdate;
import king.server.gameserver.taskmanager.tasks.TaskShutdown;
