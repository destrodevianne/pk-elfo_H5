...
public class DimensionalRiftManager
{
	...
	private void loadRooms()
	{
		...
		_log.info(getClass().getSimpleName() + ": " + typeSize + " room types with " + roomSize + " rooms.");
	}
	...
	public void loadSpawns()
	{
		...
		_log.info(getClass().getSimpleName() + ": " + countGood + " dimensional rift spawns, " + countBad + " errors.");
	}
