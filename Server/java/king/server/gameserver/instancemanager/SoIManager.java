...
public class SoIManager
{
	...
	public SoIManager()
	{
		_log.info("Seed of Infinity Manager: Current stage is: " + getCurrentStage());
		checkStageAndSpawn();
		if (isSeedOpen())
		{
	...
	public static void closeSeed()
	{
		...
		king.server.gameserver.scripts.data.EnergySeeds.SoiSeedStop();
	...
	{
		king.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthStop();
		king.server.gameserver.scripts.data.EnergySeeds.SoiMouthStop();
		king.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Stop();
		king.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Stop();
		switch (getCurrentStage())
		{
			case 1:
			case 4:
				king.server.gameserver.scripts.data.EnergySeeds.SoiMouthSpawn();
				king.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			case 5:
				king.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				king.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			default:
				king.server.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				king.server.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Spawn();
				break;
		}
	}
	...
	{
		king.server.gameserver.scripts.data.EnergySeeds.SoiSeedSpawn();
	}
