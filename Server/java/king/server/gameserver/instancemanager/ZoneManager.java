...
import king.server.gameserver.model.zone.form.ZoneCuboid;
import king.server.gameserver.model.zone.form.ZoneCylinder;
import king.server.gameserver.model.zone.form.ZoneNPoly;
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("king.server.gameserver.model.zone.type.L2" + zoneType);
