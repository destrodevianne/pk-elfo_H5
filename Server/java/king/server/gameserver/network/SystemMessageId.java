...
public final class SystemMessageId
{
	 ...
	 * Message: Female guards notice the disguises from far away better than the male guards do, so beware.
	 */
	public static final SystemMessageId FEMALE_GUARDS_NOTICE_BETTER_THANT_MALE;
	...
	static
	{
		...
		USING_INVISIBLE_SKILL_SNEAK_IN = new SystemMessageId(6506);
		MALE_GUARDS_CAN_DETECT_FEMALE_CANT = new SystemMessageId(6507);
		FEMALE_GUARDS_NOTICE_FROM_FAR_AWAY_BEWARE = new SystemMessageId(6508);
		DOOR_IS_ENTRANCE_APPROACH_DEVICE = new SystemMessageId(6509);
