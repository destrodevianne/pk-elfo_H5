 ...
 */
package king.server.gameserver.network;
...
import king.server.gameserver.LoginServerThread.SessionKey;
						...
						if(Config.OFFLINE_TRADE_EFFECT)
						{
							switch(Config.OFFLINE_EFFECT_ID)
							{
								case 1:
									...
									break;
								case 2:
									getActiveChar().startAbnormalEffect(AbnormalEffect.POISON);
									break;
								case 3:
									getActiveChar().startAbnormalEffect(AbnormalEffect.ICE2);
									break;
								case 4:
									getActiveChar().startAbnormalEffect(AbnormalEffect.MUTED);
									break;
								case 5:
									getActiveChar().startAbnormalEffect(AbnormalEffect.SLEEP);
									break;
								case 6:
									getActiveChar().startAbnormalEffect(AbnormalEffect.ROOT);
									break;
								case 7:
									getActiveChar().startAbnormalEffect(AbnormalEffect.HOLD_2);
									break;
								case 8:
									getActiveChar().startAbnormalEffect(AbnormalEffect.BIG_HEAD);
									break;
								case 9:
									getActiveChar().startAbnormalEffect(AbnormalEffect.FLAME);
									break;
								case 10:
									getActiveChar().startAbnormalEffect(AbnormalEffect.FIREROOT_STUN);
									break;
								case 11:
									getActiveChar().startAbnormalEffect(AbnormalEffect.STEALTH);
									break;
								case 12:
									getActiveChar().startAbnormalEffect(AbnormalEffect.IMPRISIONING_2);
									break;
							}
						}
