...
public class TvTRoundEvent
{
	...
	public static boolean startParticipation()
	{
		...
		if (tmpl == null)
		{
			_log.warning("TvTRound Event Engine: L2NpcTemplate is a NullPointer -> Invalid npc id in configs?");
			return false;
		}
		...
		{
			_log.log(Level.WARNING, "TvTRound Event Engine: exception: " + e.getMessage(), e);
			return false;
		}
