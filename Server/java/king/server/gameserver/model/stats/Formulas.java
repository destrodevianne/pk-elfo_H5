...
import king.server.gameserver.model.skills.L2TraitType;
import king.server.gameserver.model.skills.funcs.formulas.FuncArmorSet;
import king.server.gameserver.model.skills.funcs.formulas.FuncAtkAccuracy;
import king.server.gameserver.model.skills.funcs.formulas.FuncAtkCritical;
import king.server.gameserver.model.skills.funcs.formulas.FuncAtkEvasion;
import king.server.gameserver.model.skills.funcs.formulas.FuncBowAtkRange;
import king.server.gameserver.model.skills.funcs.formulas.FuncCrossBowAtkRange;
import king.server.gameserver.model.skills.funcs.formulas.FuncGatesMDefMod;
import king.server.gameserver.model.skills.funcs.formulas.FuncGatesPDefMod;
import king.server.gameserver.model.skills.funcs.formulas.FuncHenna;
import king.server.gameserver.model.skills.funcs.formulas.FuncMAtkCritical;
import king.server.gameserver.model.skills.funcs.formulas.FuncMAtkMod;
import king.server.gameserver.model.skills.funcs.formulas.FuncMAtkSpeed;
import king.server.gameserver.model.skills.funcs.formulas.FuncMDefMod;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxCpAdd;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxCpMul;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxHpAdd;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxHpMul;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxMpAdd;
import king.server.gameserver.model.skills.funcs.formulas.FuncMaxMpMul;
import king.server.gameserver.model.skills.funcs.formulas.FuncMoveSpeed;
import king.server.gameserver.model.skills.funcs.formulas.FuncPAtkMod;
import king.server.gameserver.model.skills.funcs.formulas.FuncPAtkSpeed;
import king.server.gameserver.model.skills.funcs.formulas.FuncPDefMod;
import king.server.gameserver.model.zone.ZoneId;
import king.server.gameserver.model.zone.type.L2CastleZone;
import king.server.gameserver.model.zone.type.L2ClanHallZone;
import king.server.gameserver.model.zone.type.L2FortZone;
import king.server.gameserver.model.zone.type.L2MotherTreeZone;
...
public final class Formulas
{
	...
	public static final double calcPhysDam(L2Character attacker, L2Character target, L2Skill skill, byte shld, boolean crit, boolean dual, boolean ss)
	{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DAGGER))
		{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BOW))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.BLUNT))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUALFIST))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.DUAL))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.SWORD))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
		...
		if ((target instanceof L2PcInstance) && (weapon != null) && (weapon.getItemType() == L2WeaponType.POLE))
		{
			L2Armor armor = ((L2PcInstance) target).getActiveChestArmorItem();
			if (armor != null)
			{
