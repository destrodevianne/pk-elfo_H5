 ...
 */
package king.server.gameserver.model.quest;
...
import king.server.gameserver.model.olympiad.CompetitionType;
import king.server.gameserver.model.quest.AITasks.AggroRangeEnter;
import king.server.gameserver.model.quest.AITasks.SeeCreature;
import king.server.gameserver.model.quest.AITasks.SkillSee;
...
import king.server.gameserver.network.serverpackets.NpcQuestHtmlMessage;
...
import king.server.gameserver.scripting.ManagedScript;
import king.server.gameserver.scripting.ScriptManager;
...
public class Quest extends ManagedScript
{
	...
	public static enum QuestEventType
	{
		...
		ON_MOVE_FINISHED(true), // Triggers, when monster finishes its move
	 ...
	 * Use this method instead of importing {@link king.server.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link king.server.gameserver.GameTimeController}.
	 */
