...
import king.server.gameserver.model.skills.funcs.FuncGet;
...
public class HeartInfinityAttack extends Quest
{
	...
	private void handleEkimusStats(HIAWorld world)
	{
		...
		world.ekimus.addStatFunc(new FuncGet(Stats.POWER_ATTACK, 0x30, this, world.ekimus.getTemplate()._basePAtk * 3));
		world.ekimus.addStatFunc(new FuncGet(Stats.MAGIC_ATTACK, 0x30, this, world.ekimus.getTemplate()._baseMAtk * 10));
		world.ekimus.addStatFunc(new FuncGet(Stats.POWER_DEFENCE, 0x30, this, world.ekimus.getTemplate()._basePDef * a[1]));
		world.ekimus.addStatFunc(new FuncGet(Stats.MAGIC_DEFENCE, 0x30, this, world.ekimus.getTemplate()._baseMDef * a[0]));
		world.ekimus.addStatFunc(new FuncGet(Stats.REGENERATE_HP_RATE, 0x30, this, world.ekimus.getTemplate()._baseHpReg * a[2]));
	}
