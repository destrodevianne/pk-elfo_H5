...
public class Q00620_FourGoblets extends Quest
{
	...
	private final int[] TALKNPCS = new int[]
	{
		GHOST_OF_WIGOTH_1,
		GHOST_OF_WIGOTH_2,
		CONQ_SM,
	...
	private final int[] STARTNPCS = new int[]
	{
		CONQ_SM,
		EMPER_SM,
		SAGES_SM,
	...
	private final int[] GOBLETS = new int[]
	{
		7256,
		7257,
		7258,
	...
	private final int[] RCP_REWARDS = new int[]
	{
		6881,
		6883,
		6885,
	...
	public Q00620_FourGoblets(int questId, String name, String descr)
	{
		...
		for (int element : TALKNPCS)
		{
			addTalkId(element);
		}
		
		for (int element : STARTNPCS)
		{
			addTalkId(element);
		}
		
		for (int element : MOBS)
		{
			addKillId(element);
		}
	...
	{
		new Q00620_FourGoblets(620, Q00620_FourGoblets.class.getSimpleName(), "Four Goblets");
	}
}