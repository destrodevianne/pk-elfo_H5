...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see king.server.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link king.server.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see king.server.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see king.server.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see king.server.util.Rnd#get(int n)
	 */
