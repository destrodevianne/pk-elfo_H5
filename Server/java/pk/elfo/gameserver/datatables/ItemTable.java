...
import pk.elfo.gameserver.engines.DocumentEngine;
import pk.elfo.gameserver.engines.items.Item;
...
public class ItemTable
{
	...
	private void load()
	{
		...
		_log.log(Level.INFO, getClass().getSimpleName() + ": " + _etcItems.size() + " Etc Items");
		_log.log(Level.INFO, getClass().getSimpleName() + ": " + _armors.size() + " Armor Items");
		_log.log(Level.INFO, getClass().getSimpleName() + ": " + _weapons.size() + " Weapon Items");
		_log.log(Level.INFO, getClass().getSimpleName() + ": " + (_etcItems.size() + _armors.size() + _weapons.size()) + " Items no total.");
	}
