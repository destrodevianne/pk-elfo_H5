...
import pk.elfo.gameserver.model.L2SkillLearn.SubClassData;
...
import pk.elfo.gameserver.model.base.SocialClass;
import pk.elfo.gameserver.model.base.SubClass;
import pk.elfo.gameserver.model.holders.ItemHolder;
import pk.elfo.gameserver.model.holders.PlayerSkillHolder;
...
public final class SkillTreesData extends DocumentParser
{
	...
	public void load()
	{
		...
		// Load files.
		parseDirectory(new File(Config.DATAPACK_ROOT, "data/stats/skillTrees/"));
	...
	private void report()
	{
		...
		_log.info(className + ": " + classSkillTreeCount + " Class Skills for " + _classSkillTrees.size() + " Class Skill Trees.");
		_log.info(className + ": " + _subClassSkillTree.size() + " Sub-Class Skills.");
		_log.info(className + ": " + trasferSkillTreeCount + " Transfer Skills for " + _transferSkillTrees.size() + " Transfer Skill Trees.");
		_log.info(className + ": " + _fishingSkillTree.size() + " Fishing Skills, " + dwarvenOnlyFishingSkillCount + " Dwarven only Fishing Skills.");
		_log.info(className + ": " + _collectSkillTree.size() + " Collect Skills.");
		_log.info(className + ": " + _pledgeSkillTree.size() + " Pledge Skills, " + (_pledgeSkillTree.size() - resSkillCount) + " for Pledge and " + resSkillCount + " Residential.");
		_log.info(className + ": " + _subPledgeSkillTree.size() + " Sub-Pledge Skills.");
		_log.info(className + ": " + _transformSkillTree.size() + " Transform Skills.");
		_log.info(className + ": " + _nobleSkillTree.size() + " Noble Skills.");
		_log.info(className + ": " + _heroSkillTree.size() + " Hero Skills.");
		_log.info(className + ": " + _gameMasterSkillTree.size() + " Game Master Skills.");
		_log.info(className + ": " + _gameMasterAuraSkillTree.size() + " Game Master Aura Skills.");
		final int commonSkills = _commonSkillTree.size();
		if (commonSkills > 0)
		{
			_log.info(className + ": " + commonSkills + " Common Skills to all classes.");
		}
	}
