...
public class Shutdown extends Thread
{
	...
	public void run()
	{
		if (this == getInstance())
		{
			...
			try
			{
				...
				_log.info("Todos os players desconectados e salvos(" + tc.getEstimatedTimeAndRestartCounter() + "ms).");
			}
			catch (Throwable t)
			{
				// ignore
	...
	private void saveData()
	{
		...
		EventsInterface.shutdown();
		_log.info("[Event Manager]: Saving events...");
