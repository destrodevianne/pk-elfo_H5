 ...
 */
package pk.elfo.gameserver.engines.items;
...
import pk.elfo.gameserver.engines.DocumentBase;
...
public final class DocumentItem extends DocumentBase
{
	...
	private void makeItem() throws InvocationTargetException
	{
		...
		try
		{
			Constructor<?> c = Class.forName("pk.elfo.gameserver.model.items.L2" + _currentItem.type).getConstructor(StatsSet.class);
