...
import pk.elfo.gameserver.model.entity.DimensionalRift;
...
import pk.elfo.gameserver.network.serverpackets.ExAskModifyPartyLooting;
import pk.elfo.gameserver.network.serverpackets.ExCloseMPCC;
import pk.elfo.gameserver.network.serverpackets.ExOpenMPCC;
...
import pk.elfo.gameserver.network.serverpackets.ExSetPartyLooting;
import pk.elfo.gameserver.network.serverpackets.L2GameServerPacket;
import pk.elfo.gameserver.network.serverpackets.PartyMemberPosition;
import pk.elfo.gameserver.network.serverpackets.PartySmallWindowAdd;
import pk.elfo.gameserver.network.serverpackets.PartySmallWindowAll;
import pk.elfo.gameserver.network.serverpackets.PartySmallWindowDelete;
...
public class L2Party extends AbstractPlayerGroup
{
	 ...
	 * @see pk.elfo.gameserver.model.actor.instance.L2PcInstance#isRequestExpired()
	 */
