 ...
 */
package pk.elfo.gameserver.model.quest;
...
import pk.elfo.gameserver.model.quest.AITasks.AggroRangeEnter;
import pk.elfo.gameserver.model.quest.AITasks.SeeCreature;
import pk.elfo.gameserver.model.quest.AITasks.SkillSee;
...
import pk.elfo.gameserver.network.serverpackets.NpcQuestHtmlMessage;
...
import pk.elfo.gameserver.scripting.ManagedScript;
import pk.elfo.gameserver.scripting.ScriptManager;
...
public class Quest extends ManagedScript
{
	 ...
	 * Use this method instead of importing {@link pk.elfo.util.Rnd} utility.
	...
	/**
	 * @return the number of ticks from the {@link pk.elfo.gameserver.GameTimeController}.
	 */
