...
public class L2Spawn
{
	...
	public L2Spawn(L2NpcTemplate mobTemplate) throws SecurityException, ClassNotFoundException, NoSuchMethodException
	{
		...
		{
			int.class,
			Class.forName("pk.elfo.gameserver.model.actor.templates.L2NpcTemplate")
		};
		_constructor = Class.forName("pk.elfo.gameserver.model.actor.instance." + _template.getType() + "Instance").getConstructor(parameters);
	}
