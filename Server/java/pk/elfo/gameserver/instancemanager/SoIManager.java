...
public class SoIManager
{
	...
	public static void closeSeed()
	{
		...
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiSeedStop();
	...
	{
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiCloseMouthStop();
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiMouthStop();
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Stop();
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Stop();
		switch (getCurrentStage())
		{
			case 1:
			case 4:
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiMouthSpawn();
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			case 5:
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze2Spawn();
				break;
			default:
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiCloseMouthSpawn();
				pk.elfo.gameserver.scripts.data.EnergySeeds.SoiAbyssGaze1Spawn();
				break;
		}
	}
	...
	{
		pk.elfo.gameserver.scripts.data.EnergySeeds.SoiSeedSpawn();
	}
