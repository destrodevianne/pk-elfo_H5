...
import pk.elfo.gameserver.model.zone.AbstractZoneSettings;
import pk.elfo.gameserver.model.zone.L2ZoneRespawn;
import pk.elfo.gameserver.model.zone.L2ZoneType;
import pk.elfo.gameserver.model.zone.form.ZoneCuboid;
import pk.elfo.gameserver.model.zone.form.ZoneCylinder;
import pk.elfo.gameserver.model.zone.form.ZoneNPoly;
import pk.elfo.gameserver.model.zone.type.L2ArenaZone;
import pk.elfo.gameserver.model.zone.type.L2OlympiadStadiumZone;
...
public class ZoneManager extends DocumentParser
{
			...
			if ("list".equalsIgnoreCase(n.getNodeName()))
			{
				...
				for (Node d = n.getFirstChild(); d != null; d = d.getNextSibling())
				{
					if ("zone".equalsIgnoreCase(d.getNodeName()))
					{
						...
						try
						{
							newZone = Class.forName("pk.elfo.gameserver.model.zone.type.L2" + zoneType);
	...
	{
		_log.info(getClass().getSimpleName() + ": Carregando zonas...");
		_classZones.clear();
		...
		_log.info(getClass().getSimpleName() + ": " + _classZones.size() + " zone classes e " + getSize() + " zones em " + (started / 1000) + " segundos.");
	}
