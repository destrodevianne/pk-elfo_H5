...
public class PartyMatchingBoard
{
    ...
    private final TextBuilder partyMatchingList = new TextBuilder();
    ...
    private void addPartyMatchingMember(String charName, int charLevel, int charClan, int charClassId, int charBaseClassId)
    {
        ...
        partyMatchingList.append("<td fixwidth=245 align=center>" + charName + "</td>");
        partyMatchingList.append("<td fixwidth=50 align=center>" + charLevel + "</td>");
        partyMatchingList.append("<td fixwidth=10></td>");

        if (charClan != 0)
        {
            partyMatchingList.append("<td fixwidth=235 align=center>" + ClanTable.getInstance().getClan(charClan).getName() + "</td>");
        }
        else
        {
        ...
        partyMatchingList.append("<td fixwidth=14 height=18><img src=\"L2UI_CH3." + getClassIcon(charClassId) + "\" width=12 height=12></td>");
        partyMatchingList.append("<td fixwidth=125>" + ClassListData.getInstance().getClass(charClassId).getClassName() + "</td>");
        ...
        partyMatchingList.append("<td fixwidth=80 align=center><button action=\"bypass -h partyMatchingInvite " + charName + " \" value=\"Invite\" width=80 height=27 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td>");
