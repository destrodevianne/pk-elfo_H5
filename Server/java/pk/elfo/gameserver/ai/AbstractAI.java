...
import pk.elfo.gameserver.network.serverpackets.AutoAttackStart;
...
public abstract class AbstractAI implements Ctrl
{
	...
	protected void moveTo(int x, int y, int z)
	{
		...
		if (!_actor.isMovementDisabled())
		{
			...
			// If monster is walking - notify whole region about walk
			if (_actor.isWalker() && (_actor.getWorldRegion() != null))
			{
				_actor.broadcastPacketToNearbyRegions(new MoveToLocation(_actor));
			}
			else
			{
				_actor.broadcastPacket(new MoveToLocation(_actor));
