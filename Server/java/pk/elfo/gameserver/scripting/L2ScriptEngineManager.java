package pk.elfo.gameserver.scripting;
...
import pk.elfo.script.jython.JythonScriptEngine;
...
public final class L2ScriptEngineManager
{
    ...
    public void executeCoreScripts()
    {
        ...
        {
            Collection<Class<?>> classes = getClassesForPackage("pk.elfo.gameserver.scripts." + pkg);
