...
import pk.elfo.gameserver.masteriopack.rankpvpsystem.RewardTable.Reward;
...
public class RPCHtmlRewardList
{
	...
	private static String[] getPvpRewardListAndPageChanger(final int pageNo, int rankId)
	{
		...
		{
			String item_name = ItemTable.getInstance().getTemplate(RPSConfig.PVP_REWARD_ID).getName();
