...
public class RankPvpSystem 
{
	...
	public static void updateNickAndTitleColor(L2PcInstance killer, PvpSummary killerPvpSummary)
	{
		...
		if(RPSConfig.NICK_COLOR_ENABLED && killer.getAppearance().getNameColor() != rank.getNickColor() && rank.getNickColor() > -1)
		{
		...
		if(RPSConfig.TITLE_COLOR_ENABLED && killer.getAppearance().getTitleColor() != rank.getTitleColor() && rank.getTitleColor() > -1)
		{
