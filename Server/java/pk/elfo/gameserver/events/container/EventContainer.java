...
import pk.elfo.gameserver.events.events.Battlefield;
import pk.elfo.gameserver.events.events.Bomb;
import pk.elfo.gameserver.events.events.CTF;
import pk.elfo.gameserver.events.events.DM;
import pk.elfo.gameserver.events.events.Domination;
import pk.elfo.gameserver.events.events.DoubleDomination;
import pk.elfo.gameserver.events.events.LMS;
import pk.elfo.gameserver.events.events.Lucky;
import pk.elfo.gameserver.events.events.Mutant;
import pk.elfo.gameserver.events.events.Russian;
import pk.elfo.gameserver.events.events.Simon;
import pk.elfo.gameserver.events.events.TvT;
import pk.elfo.gameserver.events.events.VIPTvT;
import pk.elfo.gameserver.events.events.Zombie;
