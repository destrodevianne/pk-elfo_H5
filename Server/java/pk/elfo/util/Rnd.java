...
public final class Rnd
{
	...
	protected static final class RandomContainer
	{
		 ...
		 * @see pk.elfo.util.Rnd#nextDouble()
		 */
	...
	public static enum RandomType
	{
		...
		/**
		 * Like {@link pk.elfo.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
		 * Each thread has it`s own random instance.<br>
		 * Provides best parallel access speed.
		 * @see pk.elfo.util.Rnd.ThreadLocalRandom
		 */
		 ...
		 * @see pk.elfo.util.Rnd.NonAtomicRandom
		 */
		UNSECURE_VOLATILE
	}
	 ...
	 * @param n
	 * @return
	 * @see pk.elfo.util.Rnd#get(int n)
	 */
